...
<form action="/agedcare/savehealthrecord" method="post">
<div  class="formbody">
<div class="menu-title">Add Health Record</div>
	<div class="data-text"><input type="text" name="healthInfo" placeholder="HEALTH INFO" > </div>
	<div class="data-text"><input type="text"  name="healthSummary" placeholder="HEALTH SUMMARY"></div>
	<div class="data-text"><input type="text"  name="claims" placeholder="CLAIMS"></div>
	<div class="data-text"><input type="text"  name="medicare" placeholder="MEDICARE"></div>
	<div class="data-text"><input type="text"  name="age" placeholder="AGE"></div>
	<div class="data-text"><input type="text"  name="emergencyContact" placeholder="EMERGENCY CONTACT"></div>
	<div class="data-button">
			<input type="submit" class="signin"  name="submit" value="ADD HEALRH RECORD"> 
	</div>
	<div class="back"><a href="/agedcare/getinformationdoctor" class="back_a">BACK</a></div>
</div>
</form>
</body>
</html>