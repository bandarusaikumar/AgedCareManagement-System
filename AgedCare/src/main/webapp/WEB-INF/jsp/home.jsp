...
<div class="menu">
<div class="home"><a href="" class="home_a">Home</a></div>
<div  class="nurse_visiting"><a href="" class="nurse_visiting_a">NURSE VISITING</a></div>
<div  class="contact_admin"><a href="" class="contact_admin_a">CONTACT ADMIN</a></div>
<div  class="g_i_f_d"><a href="" class="g_i_f_d_a">GET INFORMATION FROM DOCTOR</a></div>
<div  class="logout"><a href="" class="logout_a">LOGOUT</a></div>
</div>
