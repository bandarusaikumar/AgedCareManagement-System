...
<table border="0" cellpadding="2" cellspacing="2"  width="90%" align="center"> 
	<tr><td align="right" class="textbold"><font color="blue"><a href="/agedcare/admincontactadd/${patient.patientId}">Add New</a></font> </td></tr>
	</table>
	...
	<table align="center" border="2" cellpadding="2" width="90%">
		...
		<c:forEach items="${adminContacts}" var="adminContact">
			<tr>
				...
				<td><c:out value="${adminContact.patientId}"/></td>
